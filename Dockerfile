...
RUN mkdir -p /home/dummy/.aria2/
RUN echo "max-download-result=100000" >> /home/dummy/.aria2/aria2.conf
RUN echo "max-concurrent-downloads=10" >> /home/dummy/.aria2/aria2.conf
RUN echo "log=/tmp/aria2c.log" >> /home/dummy/.aria2/aria2.conf
RUN echo "download-result=full" >> /home/dummy/.aria2/aria2.conf
RUN echo "continue=true" >> /home/dummy/.aria2/aria2.conf
RUN echo "allow-overwrite=true" >> /home/dummy/.aria2/aria2.conf
